...
async function GET(request) {
    try {
        ...
        const orders = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({}).populate('customer', 'firstName lastName email').sort({
            createdAt: -1
        });
...
async function POST(request) {
    try {
        ...
        const order = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create(body);
...
async function PUT(request) {
    try {
        ...
        const order = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(_id, updateData, {
            new: true
        });
        if (!order) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__14e96196._.js.map