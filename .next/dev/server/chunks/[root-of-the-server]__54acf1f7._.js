...
async function GET() {
    try {
        ...
        const [crmContacts, customers, subscribers] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Contact$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({}).sort({
                createdAt: -1
            }).lean(),
            __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Customer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({}).sort({
                createdAt: -1
            }).lean(),
            __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Subscriber$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({}).sort({
                createdAt: -1
            }).lean()
        ]);
        ...
        const formattedCrmContacts = crmContacts.map((c)=>({
                ...c,
                source: 'CRM'
            }));
        const allContacts = [
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(allContacts);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__54acf1f7._.js.map