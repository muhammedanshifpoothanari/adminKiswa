...
async function GET(request) {
    try {
        ...
        const attendance = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Attendance$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(query).populate('employee', 'firstName lastName').sort({
            date: -1
        });
...
async function POST(request) {
    try {
        ...
        const attendance = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Attendance$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndUpdate({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f9f832d4._.js.map